...
public class UpdateTournamentSagaData {
    ...
    BeginUpdateTournamentCommand beginUpdateTournament() {
        logger.info("Sent BeginUpdateTournamentCommand");
        return new BeginUpdateTournamentCommand(getTournamentId());
    }
