...
public class TutorException extends RuntimeException {
    public enum ExceptionError {
        ...
        QUIZ_MISMATCH, OPTION_NOT_FOUND, USER_NOT_FOUND, QUESTION_MISMATCH, QUIZ_ALREADY_ANSWERED, QUESTION_NOT_FOUND, QUESTION_MISSING_DATA, QUESTION_MULTIPLE_CORRECT_OPTIONS, QUESTION_CHANGE_CORRECT_OPTION_HAS_ANSWERS;
    }
