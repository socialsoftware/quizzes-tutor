...
public class StatementQuizDto implements Serializable {
    ...
    public StatementQuizDto(QuizAnswer quizAnswer, boolean complete) {
        ...
        this.timed = quizAnswer.getQuiz().getType().equals(QuizType.IN_CLASS);
        ...
        if (quizAnswer.getQuiz().getConclusionDate() != null && (quizAnswer.getQuiz().getType().equals(QuizType.IN_CLASS) || quizAnswer.getQuiz().getType().equals(QuizType.EXTERNAL_QUIZ))) {
