...
class CreateTecnicoCourseExecutionTest extends SpockTest {
    ...
    def "the course exists and create execution course"() {
        ...
        def courseExecution = courseExecutionRepository.findByFields(COURSE_1_ACRONYM, COURSE_1_ACADEMIC_TERM, CourseType.TECNICO.name()).get()
    ...
    def "the course does not exist and create both, course and execution course"() {
        ...
        def course = courseRepository.findByNameType(COURSE_1_NAME, CourseType.TECNICO.name()).get()
        course != null
    ...
    def "the course and course execution exist"() {
        def courseDto = externalCourseExecution.getDto()
