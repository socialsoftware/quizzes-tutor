...
class ImportExportAnswersTest extends SpockTest {
    ...
    def setup() {
        ...
        User user = userService.createUserWithAuth(USER_1_NAME, USER_1_USERNAME, USER_1_EMAIL, User.Role.STUDENT, pt.ulisboa.tecnico.socialsoftware.tutor.user.domain.AuthUser.Type.EXTERNAL).getUser()
