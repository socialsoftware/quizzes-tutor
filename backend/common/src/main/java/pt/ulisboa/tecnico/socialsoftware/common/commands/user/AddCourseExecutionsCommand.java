...
public class AddCourseExecutionsCommand implements Command {

    private Integer userId;
    private List<CourseExecutionDto> courseExecutionDtoList;

    public AddCourseExecutionsCommand() {
    }

    public AddCourseExecutionsCommand(Integer userId, List<CourseExecutionDto> courseExecutionDtoList) {
        this.userId = userId;
