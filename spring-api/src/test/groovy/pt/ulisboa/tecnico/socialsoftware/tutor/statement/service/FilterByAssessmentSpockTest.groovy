...
class FilterByAssessmentSpockTest extends Specification {
    ...
    def setup() {
        ...
        questionTopic1Again.setNumber(5)
    ...
    def "check assessment topic 1"() {
        ...
        assessmentTopic1.addTopicConjunctions(topicConjunction1)
    ...
    def "check assessment topic 1 and 2"() {
        ...
        assessmentTopic1_and_2.addTopicConjunctions(topicConjunction1_and_2)
    ...
    def "check assessment topic 1 or 2"() {
        ...
        def topicConjunction1 = new TopicConjunction()
        topicConjunction1.addTopic(topic1)
        assessmentTopic1_or_2.addTopicConjunctions(topicConjunction1)
        def topicConjunction2 = new TopicConjunction()
        topicConjunction2.addTopic(topic2)
        assessmentTopic1_or_2.addTopicConjunctions(topicConjunction2)
