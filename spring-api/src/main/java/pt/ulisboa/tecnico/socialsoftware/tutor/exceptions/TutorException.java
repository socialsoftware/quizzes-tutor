...
public class TutorException extends RuntimeException {
    public enum ExceptionError {
        ...
        DUPLICATE_USER, USERS_IMPORT_ERROR, QUESTIONS_IMPORT_ERROR, TOPICS_IMPORT_ERROR, QUIZZES_IMPORT_ERROR, QUIZ_HAS_ANSWERS, QUIZ_QUESTION_HAS_ANSWERS, ASWERS_IMPORT_ERROR;
    }
